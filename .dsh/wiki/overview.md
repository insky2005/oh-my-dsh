...
docs/                设计与排查文档（repo-wiki-design.md、review-panel-design.md（审查面板设计/覆盖矩阵）、skills-manager-design.md（技能面板：四档级别判定 / registry 模型 / 开关可逆写法）、productization.md、git-workflow.md、release-process.md、dsh-version-impact.md、milestones/、plans/、terminal-header-fix.md、terminal-input-fix.md、channel-*.md、raw/）
