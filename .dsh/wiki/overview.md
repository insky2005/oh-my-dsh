...
tests/               无头单元测试（terminal-emulator/、wiki-panel/、browser-panel/、channel-panel/、dsh-rpc/、review-panel/、skills/，各含 run.sh；模拟器测试已迁 core/tests/ansi.test.js 的薄封装）
