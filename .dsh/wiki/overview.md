...
- 通道（channel）能力 README 未收录，设计/指令/状态/存储文档在 `docs/channel-*.md`；消息/会话存储**全局化改造**（docs/channel-storage.md，2026-08-22 定稿）**未实现**——当前消息/会话仍落项目目录（v1），引用配置 `.dsh/channels.json` 旧路径文件仍未跟踪。
